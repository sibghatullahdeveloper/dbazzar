			...
			<ul class="navbar-nav">
				...
				<li class="nav-item dropdown dropdown-user">
					<a href="#" class="navbar-nav-link d-flex align-items-center dropdown-toggle" data-toggle="dropdown">
						...
						<span>{{\Auth::guard('affiliate')->user()->first_name}} {{\Auth::guard('affiliate')->user()->last_name}}</span>
                        
                       
					</a>

					<div class="dropdown-menu dropdown-menu-right">
                    <a href="#" class="dropdown-item">{{\Auth::guard('affiliate')->user()->user_type}}</a>
						...
						<a href="{{route('affiliate.signout')}}" class="dropdown-item"><i class="icon-switch2"></i> Logout</a>
					</div>
				</li>
			</ul>
		</div>

						...
						<div class="card">
							...
							<div class="card-body d-sm-flex align-items-sm-center justify-content-sm-between flex-sm-wrap">
								<div class="d-flex align-items-center mb-3 mb-sm-0">
									...
									<div class="ml-3">
										<h5 class="font-weight-semibold mb-0">38,289 <span class="text-success-300 font-size-sm font-weight-normal"><i class="icon-arrow-up12"></i> (+16.2%)</span></h5>
										<span class="badge badge-mark border-success-300 mr-1"></span> <span class="text-muted">May 12, 12:30 am</span>
									</div>
								</div>
								...
								<div class="d-flex align-items-center mb-3 mb-sm-0">
									...
									<div class="ml-3">
										<h5 class="font-weight-semibold mb-0">2,458 <span class="text-orange-300 font-size-sm font-weight-normal"><i class="icon-arrow-down12"></i> (-4.9%)</span></h5>
										<span class="badge badge-mark border-orange mr-1"></span> <span class="text-muted">Jun 4, 4:00 am</span>
									</div>
								</div>
								...
								<table class="table text-nowrap">
									...
									<tbody>
										...
										<tr>
												...
												<div class="d-flex align-items-center">
													...
													<div>
														...
														<div class="text-muted font-size-sm">
															<span class="badge badge-mark border-blue-300 mr-1"></span>
															02:00 - 03:00
														</div>
													</div>
												</div>
											...
											<td><span class="text-success-300"><i class="icon-stats-growth2 mr-2"></i> 2.43%</span></td>
										...
										<tr>
											<td>
												<div class="d-flex align-items-center">
													...
													<div>
														...
														<div class="text-muted font-size-sm">
															<span class="badge badge-mark border-danger-300 mr-1"></span>
															13:00 - 14:00
														</div>
													</div>
												</div>
											...
											<td><span class="text-success-300"><i class="icon-stats-growth2 mr-2"></i> 3.12%</span></td>
										...
										<tr>
											<td>
												<div class="d-flex align-items-center">
													...
													<div>
														...
														<div class="text-muted font-size-sm">
															<span class="badge badge-mark border-grey-300 mr-1"></span>
															10:00 - 11:00
														</div>
													</div>
												</div>
											...
											<td><span class="text-danger-300"><i class="icon-stats-decline2 mr-2"></i> - 8.02%</span></td>
										...
										<tr>
											...
											<td><span class="text-success-300"><i class="icon-stats-growth2 mr-2"></i> 2.78%</span></td>
										...
										<tr>
											<td>
												<div class="d-flex align-items-center">
													...
													<div>
														...
														<div class="text-muted font-size-sm">
															<span class="badge badge-mark border-success-300 mr-1"></span>
															15:00 - 16:00
														</div>
													</div>
												</div>
											...
											<td><span class="text-danger-300"><i class="icon-stats-decline2 mr-2"></i> - 5.78%</span></td>
										...
										<tr>
											...
											<td><span class="text-success-300"><i class="icon-stats-growth2 mr-2"></i> 6.79%</span></td>
										...
										<tr>
											...
											<td><span class="text-danger-300"><i class="icon-stats-decline2 mr-2"></i> 9.83%</span></td>
						...
						<div class="card">
							...
							<div class="card-body d-md-flex align-items-md-center justify-content-md-between flex-md-wrap">
								<div class="d-flex align-items-center mb-3 mb-md-0">
									...
									<div class="ml-3">
										<h5 class="font-weight-semibold mb-0">14,327 <span class="text-success-300 font-size-sm font-weight-normal"><i class="icon-arrow-up12"></i> (+2.9%)</span></h5>
										<span class="badge badge-mark border-success-300 mr-1"></span> <span class="text-muted">Jun 16, 10:00 am</span>
									</div>
								</div>

								<div class="d-flex align-items-center mb-3 mb-md-0">
									<a href="#" class="btn bg-transparent border-blue-300 text-blue-300 rounded-round border-2 btn-icon">
						...
						<div class="row">
							<div class="col-sm-6">
								...
								<div class="card text-center">
									<div class="card-body">
										<h3 class="card-title">Credit</h4>
										<h6 class="card-title"><span class="badge bg-success badge-pill">Total Commision</span></h6>
										<h5 class="font-weight-semibold mb-0">PKR {{$totalcredit}}</h5><br>
										<span class="badge badge-mark border-success-300 mr-1"></span> <span class="text-muted">Date: {{date("d-m-y")}}</span>
									</div>
								</div>
							...
							<div class="col-sm-6">
								...
								<div class="card text-center">
									<div class="card-body">
										...
										<h6 class="card-title"><span class="badge bg-success badge-pill">Total Commision</span></h6>
										<h5 class="font-weight-semibold mb-0">PKR {{$totaldebit}}</h5><br>
										<span class="badge badge-mark border-success-300 mr-1"></span> <span class="text-muted">Date: {{date("d-m-y")}}</span>
									</div>
								</div>
									...
									<ul class="media-list">
										<li class="media">
											<div class="mr-3 position-relative">
												...
												<span class="badge bg-pink-400 badge-pill badge-float">8</span>
											</div>
										...
										<li class="media">
											<div class="mr-3 position-relative">
												<img src="../../../../global_assets/images/placeholders/placeholder.jpg" class="rounded-circle" width="36" height="36" alt="">
												<span class="badge bg-pink-400 badge-pill badge-float">6</span>
											</div>
						...
						<div class="card">
							...
							<div class="card-body">
								...
								<ul class="media-list">
									<li class="media">
										<div class="mr-3">
											<a href="#" class="btn bg-transparent border-pink-300 text-pink-300 rounded-round border-2 btn-icon"><i class="icon-statistics"></i></a>
										</div>
									...
									<li class="media">
										<div class="mr-3">
											<a href="#" class="btn bg-transparent border-success-300 text-success-300 rounded-round border-2 btn-icon"><i class="icon-checkmark3"></i></a>
										</div>
									...
									<li class="media">
										<div class="mr-3">
											<a href="#" class="btn bg-transparent border-primary-300 text-primary-300 rounded-round border-2 btn-icon"><i class="icon-alignment-unalign"></i></a>
										</div>
									...
									<li class="media">
										<div class="mr-3">
											<a href="#" class="btn bg-transparent border-warning-300 text-warning-300 rounded-round border-2 btn-icon"><i class="icon-spinner11"></i></a>
										</div>
									...
									<li class="media">
										<div class="mr-3">
											<a href="#" class="btn bg-transparent border-teal-300 text-teal-300 rounded-round border-2 btn-icon"><i class="icon-redo2"></i></a>
										</div>

          ...
          <div class="col-md-12">
            <div class="card">
                ...
                <div class="row">
                  <div class="col-md-10 offset-md-1">
                    <div class="header-elements-inline">
                      <h5 class="card-title">Create Product Variation Item Form</h5>
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-md-10 offset-md-1">
                    <form action="{{route('entity.storeProdVariationItems')}}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                    {{ csrf_field() }}
                      ...
                      <div class="form-group">
                        ...
                        <select data-placeholder="Select Category" class="form-control select" name="p_cat_ids[]" data-fouc multiple>

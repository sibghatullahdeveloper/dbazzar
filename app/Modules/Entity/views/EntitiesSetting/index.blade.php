        ...
        <div class="content-wrapper">
            ...
            <div class="card">
                ...
                <div class="card-body" width="100%">
                    ...
                    <a type="button" class="btn btn-outline-success" href="{{route('entity.entity_settings_create')}}" ><i class="icon-plus3"></i>Create settings</a>
                    <a type="button" class="btn btn-outline-success" href="{{route('entity.entity_settings')}}" ><i class="icon-plus3"></i>List</a>
                        ...
                        <tr>
                            ...
                            <td class="text-center" style="display: contents;">
                                <div class="list-icons">
                                    <div class="dropdown">
                                        <a href="{{route('entity.entity_settings_edit' , $list->entity->uuid)}}" class="list-icons-item">
                                            <i class="btn btn-primary icon-pencil3"></i>
                                        </a>
                                        |
                                        <a href="{{ route('entity.entity_settings_delete',$list->uuid) }}" class="list-icons-item">

          ...
          <div class="col-xl-8">
            ...
            <div class="card">
              <div class="card-header header-elements-sm-inline">
                <h6 class="card-title"><i class="icon-stack4"></i> Orders Table</h6>
              </div>
              ...
              <div class="table-responsive">
                <table class="table text-nowrap">
                  <thead>
                    <tr>
                      <th><span class="badge badge-mark border-success-300 mr-1"></span>Ref#</th>
                      <th><span class="badge badge-mark border-success-300 mr-1"></span>Entity Name</th>
                      <th><span class="badge badge-mark border-success-300 mr-1"></span>Name</th>
                      <th><span class="badge badge-mark border-success-300 mr-1"></span>Total</th>
                      <th><span class="badge badge-mark border-success-300 mr-1"></span>Payment Type</th>
                      <th><span class="badge badge-mark border-success-300 mr-1"></span>Date</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr class="table-active table-border-double">
                      <td colspan="6">Recent 10 Orders</td>
                    </tr>
                      ...
                      <tr>
                        <td>
                          <div class="d-flex align-items-center">
                            <div>
                              <a href="#" class="text-default font-weight-semibold">{{$info->id}}</a>
                            </div>
                          </div>
                        </td>
                        @if($info->entitybranch)
                          <td><span class="text-muted">{{$info->entitybranch->title}}</span></td>
                        @endif
                        <td><span class="text-muted">{{$info->name}}</span></td>
                        <td><h6 class="font-weight-semibold mb-0">{{$info->total_amount}}</h6></td>
                        <td><span class="text-muted">{{$info->payment_mode}}</span></td>
                        <td><span class="text-muted">{{$info->created_at}}</span></td>
                      </tr>
                    @endforeach

                            ...
                            <div class="p-3 w-100">
                                ...
                                <div class="row no-gutters justify-content-center">
                                    <div class="col-sm-8 col-xl-6">
                                        <form class="js-validation-signup" action="{{ route('forgot_password') }}" method="POST">
                                        {{csrf_field()}}
                                            @if ($errors->any())
                                            ...
                                            <div class="form-group">
                                                ...
                                                <p class="mt-3 mb-0 d-lg-flex justify-content-lg-between">
                                                    <a class="btn btn-sm btn-light d-block d-lg-inline-block mb-1" href="{{route('createCheckout')}}">
